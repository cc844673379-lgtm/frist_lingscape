---
name: faq-page
description: "A Frequently Asked Questions (FAQ) page with collapsible accordion sections, search functionality Invoke when: faq, FAQ, frequently asked questions, help center, support page, Q&A, 常见问题, 帮助中心"
od:
  mode: prototype
  platform: desktop
  scenario: support
