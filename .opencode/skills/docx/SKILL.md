---
name: docx
description: "Create, edit, and analyze Word documents with tracked changes, comments, and formatting. Invoke when: docx, word document, tracked changes, design brief doc, copy doc"
od:
  mode: prototype
  category: documents
