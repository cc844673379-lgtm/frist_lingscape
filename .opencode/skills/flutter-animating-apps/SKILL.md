...
description: "Implement animated effects, transitions, and motion in Flutter apps. Invoke when: flutter animation, flutter motion, mobile animation, flutter transitions"
od:
  mode: prototype
