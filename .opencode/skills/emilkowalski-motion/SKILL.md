...
description: "Motion-design follow-up skill inspired by Emil Kowalski's animation guidance. Invoke when: emil kowalski, motion polish, micro interaction, interaction animation"
od:
  mode: prototype
  surface: web
  platform: desktop
