...
description: "Release notes one-page HTML with highlights, Added, Fixed, Breaking changes, Known issues, and Upgrade note. Invoke when: release notes, changelog, what's new, version update, change log"
od:
  mode: prototype
  platform: desktop
