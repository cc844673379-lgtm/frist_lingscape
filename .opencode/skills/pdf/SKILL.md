---
name: pdf
description: "Extract text, create PDFs, and handle forms. Useful for press releases, branded one-pagers, and printable design deliverables. Invoke when: pdf, create pdf, pdf form, branded pdf, one pager"
od:
  mode: prototype
  category: documents
