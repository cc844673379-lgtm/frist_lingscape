---
name: gsap-utils
description: "Official GSAP skill for gsap.utils — clamp, mapRange, normalize, interpolate, random, snap, toArray, wrap Invoke when: gsap utils, clamp animation value, maprange, snap animation, gsap random"
license: MIT
od:
  mode: prototype
