...
description: "Official GSAP skill for Vue, Svelte, and other non-React frameworks — lifecycle, scoping selectors Invoke when: gsap vue, gsap svelte, nuxt animation, sveltekit animation, framework animation"
license: MIT
od:
  mode: prototype
