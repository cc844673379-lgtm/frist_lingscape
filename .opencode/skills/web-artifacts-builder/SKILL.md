...
description: "Build complex claude.ai HTML artifacts with React and Tailwind. Invoke when: web artifacts, tailwind artifact, react artifact, anthropic artifact"
od:
  mode: prototype
