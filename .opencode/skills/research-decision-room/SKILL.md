...
description: "Turn messy user research notes, interviews, support tickets, surveys Invoke when: research decision room, user research synthesis, research synthesis dashboard"
od:
  mode: prototype
  platform: desktop
  scenario: research
