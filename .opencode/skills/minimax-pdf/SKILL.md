---
name: minimax-pdf
description: "Generate, fill, and reformat PDFs with a token-based design system and 15 cover styles. Invoke when: minimax pdf, branded pdf, cover style pdf, e-guide pdf, design system pdf"
od:
  mode: prototype
  category: documents
