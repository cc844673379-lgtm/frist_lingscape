---
name: gsap-react
description: "Official GSAP skill for React — useGSAP hook, refs, gsap.context(), cleanup. Invoke when: gsap react, usegsap, react animation, gsap context, react motion"
license: MIT
od:
  mode: prototype
