---
name: gsap-core
description: "Official GSAP skill for the core API — gsap.to(), from(), fromTo(), easing, duration, stagger, defaults, gsap.matchMedia() (responsive Invoke when: gsap, gsap core, web animation, tween, easing"
license: MIT
od:
  mode: prototype
