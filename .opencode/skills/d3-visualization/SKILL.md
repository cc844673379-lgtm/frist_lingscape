...
description: "Teaches the agent to produce D3 charts and interactive data visualizations. Invoke when: d3, d3.js, interactive chart, data visualization, editorial chart, d3 bar chart"
od:
  mode: prototype
  category: diagrams
