...
description: "This skill encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions Invoke when: emil kowalski, design engineering, UI polish philosophy, animation philosophy"
od:
  mode: prototype
  surface: web
  platform: desktop
