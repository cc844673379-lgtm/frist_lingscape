...
description: "Official GSAP skill for ScrollTrigger — scroll-linked animations, pinning, scrub, triggers. Invoke when: scrolltrigger, scroll animation, gsap scroll, scroll pin, scroll scrub"
license: MIT
od:
  mode: prototype
