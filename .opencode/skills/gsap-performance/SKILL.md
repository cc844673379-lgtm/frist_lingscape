...
description: "Official GSAP skill for performance — prefer transforms, avoid layout thrashing, will-change Invoke when: gsap performance, animation jank, 60fps animation, will-change, layout thrashing"
license: MIT
od:
  mode: prototype
