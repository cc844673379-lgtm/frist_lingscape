---
name: gsap-timeline
description: "Official GSAP skill for timelines — gsap.timeline(), position parameter, nesting, playback. Invoke when: gsap timeline, animation timeline, sequenced animation, motion choreography"
license: MIT
od:
  mode: prototype
