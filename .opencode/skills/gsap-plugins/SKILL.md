---
name: gsap-plugins
description: "Official GSAP skill for GSAP plugins — registration, ScrollToPlugin, ScrollSmoother, Flip, Draggable Invoke when: gsap plugins, gsap plugin registration, flip animation, draggable, morphsvg"
license: MIT
od:
  mode: prototype
